...
func (ks *KeyStore) getDecryptedKey(a accounts.Account, auth string) (accounts.Account, *keystore.Key, error) {
	a, err := ks.Find(a)
	if err != nil {
		return a, nil, err
	}
...
func (ks *KeyStore) importKey(key *keystore.Key, passphrase string) (accounts.Account, error) {
